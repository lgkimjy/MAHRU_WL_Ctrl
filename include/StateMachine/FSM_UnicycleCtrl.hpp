...
private:
    ...
    double                                  swing_leg_reaction_com_sign_ = -1.0;
    double                                  swing_leg_reaction_com_kp_ = 0.0;
    double                                  swing_leg_reaction_com_kd_ = 0.0;
    ...
    bool                                    enable_arm_roll_momentum_task_ = false;
    double                                  arm_roll_momentum_scale_ = 0.0;
    double                                  arm_roll_momentum_max_rate_ = 300.0;

    bool                                    enable_single_wheel_stance_ = false;
    bool                                    enable_line_contact_wheel_control_ = true;
    bool                                    enable_line_contact_sagittal_wheel_feedback_ = false;
    double                                  line_contact_sagittal_wheel_sign_ = -1.0;
    double                                  line_contact_sagittal_wheel_kp_ = 0.0;
    double                                  line_contact_sagittal_wheel_kd_ = 0.0;
    double                                  line_contact_sagittal_wheel_max_vel_ = 0.0;
    ...
    double                                  single_wheel_capture_kp_ = 0.0;
    double                                  single_wheel_capture_offset_ = 0.0;
    double                                  single_wheel_max_lin_vel_ = 0.25;
    double                                  single_wheel_max_lin_acc_ = 0.0;
    bool                                    enable_single_wheel_velocity_pd_ = false;
    double                                  single_wheel_velocity_kd_ = 0.0;
    double                                  single_wheel_velocity_max_torque_ = 0.0;
    double                                  left_toe_lift_duration_ = 0.8;
    ...
    double                                  single_wheel_com_single_feedback_sign_ = 1.0;
    double                                  single_wheel_com_max_offset_ = 0.08;
    double                                  single_wheel_com_transition_time_ = 0.8;
    bool                                    single_wheel_com_transition_initialized_ = false;
    double                                  single_wheel_com_transition_start_time_ = 0.0;
    Eigen::Vector3d                         single_wheel_com_transition_start_ = Eigen::Vector3d::Zero();
    Eigen::Vector3d                         single_wheel_com_transition_start_vel_ = Eigen::Vector3d::Zero();
    ...
    double                                  line_contact_moment_x_mask_ = 0.0;
    double                                  line_contact_moment_y_mask_ = 0.0;
    ...
    Eigen::Vector3d supportSagittalAxis() const;
    Eigen::Vector3d supportLateralAxis() const;
