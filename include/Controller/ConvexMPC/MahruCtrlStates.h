...
#ifndef MAHRU_CPP_A1CTRLSTATES_H
#define MAHRU_CPP_A1CTRLSTATES_H

#include <Eigen/Dense>

// #include "MahruParams.h"
...
public:
    ...
    void reset() {
        ...
        robot_mass = 44.9;
		trunk_inertia  << 4.065, -0.000, 0.341,
				-0.000,  3.933, 0.000,
				0.341,  0.000, 1.250;
    ...
    std::vector<std::vector<bool>> contact_window;
